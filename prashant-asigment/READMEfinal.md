...
# Interpreting qPCR Results Using the ΔΔCt Method – Prahant Assignment

## Intro

Real-time quantitative PCR (qPCR) is a strong, well-used tool for comparing gene expression between experimental conditions. The ΔΔCt method enables relative quantification of gene expression by comparing cycle threshold (Ct) values across conditions, normalized to a reference gene (in our case – tubulin).
...
The following visuals present the fold change results from our qPCR analysis: a generated bar chart based on calculated ΔΔCt values and a screenshot from the assignment folder. Values above 1 indicate upregulation, and values below 1 indicate downregulation due to inhibitor treatment.

### Bar Chart of Fold Change (Generated from ΔΔCt Results)
![Bar Chart](fold_change_bar_chart.png)

### Screenshot from Assignment Folder
![Screenshot](https://github.com/Eitangeula/Reserch-Methods/blob/main/Images/barchart.png)
